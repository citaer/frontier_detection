 ...
 */
std::vector<int> nhood4(int idx, const nav_msgs::OccupancyGrid& costmap)
{
    // get 4-connected neighbourhood indexes, check for edge of map
    std::vector<int> out;

    int size_x_ = costmap.info.width, size_y_ = costmap.info.height;
 ...
 * @return neighbour cell indexes
 */
std::vector<int> nhood8(int idx, const nav_msgs::OccupancyGrid& costmap)
{
    // get 8-connected neighbourhood indexes, check for edge of map
    std::vector<int> out = nhood4(idx, costmap);
